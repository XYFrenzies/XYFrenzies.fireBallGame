var Player = function(){
    ...
    this.sprite.buildAnimation(  6, 1, 54, 71  , 0.05, [0,1,2,3,4,5,6,7,8,8,7,6,5,4,3,2,1,0] ); //JUMP LEFT

    this.sprite.buildAnimation(  6, 1, 54, 71  , 0.05, [0,0,1,1,2,2,3,3,4,4] ); //WALK LEFT
